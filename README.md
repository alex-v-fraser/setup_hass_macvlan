...
This script automates deploying [Home Assistant](https://www.home-assistant.io/) on Synology NAS with [Container Manager](https://www.synology.com/en-global/dsm/packages/ContainerManager) using a dedicated LAN IP address via `macvlan`.  
